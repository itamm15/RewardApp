    ...
    [{compile_env,[{rewardapp,['Elixir.RewardappWeb.Gettext'],error}]},
     {applications,
         [kernel,stdlib,elixir,logger,runtime_tools,phoenix,phoenix_ecto,
          ...
          telemetry_metrics,telemetry_poller,gettext,jason,bamboo,
          plug_cowboy]},
     {description,"rewardapp"},
     {modules,
         ['Elixir.Rewardapp','Elixir.Rewardapp.Application',
          'Elixir.Rewardapp.Award','Elixir.Rewardapp.Email',
          'Elixir.Rewardapp.Repo','Elixir.RewardappWeb',
          'Elixir.RewardappWeb.Endpoint','Elixir.RewardappWeb.ErrorHelpers',
          'Elixir.RewardappWeb.ErrorView','Elixir.RewardappWeb.Gettext',
          'Elixir.RewardappWeb.GrantController',
